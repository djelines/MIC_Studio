  ...
  return (
    ...
    >
      ...
      <Hero
        ...
        description="MIC, c'est Matéis, Mathys, Inès et Clément. Ensemble, nous
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-lemonade-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="px-6 md:px-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12">
            {VALUES.map((val, idx) => (
              <motion.div
                key={val.title}
                initial={{ opacity: 0, y: 20 }}
