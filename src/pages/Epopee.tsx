...
const Epopee = () => {
  ...
  return (
    <motion.div
      ...
      className=""
    >
      <div className="relative h-screen w-full flex items-center justify-center -mt-20 overflow-hidden [box-shadow:0_50px_90px_-15px_rgba(0,0,0,0.5)]">
        <div className="absolute inset-0 bg-gradient-to-b from-black via-[#050505] to-[#0f172a] opacity-95" />
        
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-slate-800 rounded-full blur-[120px] opacity-30 mix-blend-screen animate-pulse" />
